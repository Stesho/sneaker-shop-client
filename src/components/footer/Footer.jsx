          ...
          <section className={styles.follow}>
            ...
            <ul className={[styles.follow__list, styles.list].join(' ')}>
              <li className={styles.listItem}>
                <a rel="noreferrer" href="https://www.facebook.com/AtmosUSA" target="_blank">
              ...
              <li className={styles.listItem}>
                <a rel="noreferrer" href="https://twitter.com/atmos_usa" target="_blank">
              ...
              <li className={styles.listItem}>
                <a rel="noreferrer" href="https://www.instagram.com/atmos_usa" target="_blank">
              ...
              <li className={styles.listItem}>
                <a rel="noreferrer" href="https://www.youtube.com/channel/UCUnj5vzXsFFcewjRSTlgFWg" target="_blank">
